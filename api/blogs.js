...
HERO IMAGE — at the VERY END, after the closing paragraph, output ONE line exactly: [[HERO|FULL PROMPT]] — one strong square featured scene for this blog (the reader's main situation/room, ONE person, editorial look as above, plain uncluttered walls with NO invented wall art, the keyword idea reflected in the setting). This is the ONLY place you describe the hero; it becomes 5 variations later. Write it as a full photo prompt like the PHOTO rule above.`;
