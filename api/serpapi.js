export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("Found PAA questions:", paaQuestions.length);
    ...
    if (questions.length === 0) {
      console.error("No PAA questions found in SerpAPI response");
      return res.status(200).json({
        questions: [],
        error: "No People Also Ask questions found for this search. Try a different niche."
      });
    }
