...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const analysis = await getClaudeAnalysis(yourPageData, competitorData, keyword, searchResults.userPosition);
...
CRITICAL FOR SCHEMA: When recommending schema markup, write the COMPLETE JSON-LD code. Do NOT use placeholders. Example:

10. Add FAQ schema markup — paste this into the head section:
Use exactly this:
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What are the best wall art for a bedroom ideas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The best wall art for bedroom includes framed prints above the bed, gallery walls with mixed frames, and large canvas pieces. Choose calming colors and personal themes that promote relaxation."
      }
    },
    {
      "@type": "Question",
      "name": "How do I choose bedroom wall art?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Choose bedroom wall art by considering your room's color scheme, size of available wall space, and personal style preferences. Measure your wall before purchasing and ensure the art complements your bedding and furniture."
      }
    },
    {
      "@type": "Question",
...
- For schema: WRITE THE COMPLETE WORKING JSON-LD - do NOT use "..." or "etc" or placeholders
- Include 6-10 FAQ questions in schema with FULL COMPLETE answers (2-3 sentences each)
- Write actual questions people ask about "${keyword}"
