...
Format EXACTLY like this:
{
  ...
  "ai_search": [
    ...
    },
    {
      ...
      "recommended": "Create new custom liquid section, paste this EXACT code:\n\n<script type=\"application/ld+json\">\n{\n  \"@context\": \"https://schema.org\",\n  \"@type\": \"FAQPage\",\n  \"mainEntity\": [\n    {\n      \"@type\": \"Question\",\n      \"name\": \"[Question 1]\",\n      \"acceptedAnswer\": {\n        \"@type\": \"Answer\",\n        \"text\": \"[Answer 1]\"\n      }\n    }\n  ]\n}\n</script>",
      "why": "Schema markup helps Google show rich snippets and helps AI engines understand your content structure. FAQ schema increases chances of appearing in 'People Also Ask' boxes."
    },
    {
      ...
      "recommended": "Add EXACTLY these elements:\n\nAbove product grid: '✓ Free UK Delivery on Orders Over £50 | ✓ 30-Day Money Back Guarantee | ✓ Secure Checkout'\n\nIn header (right side): 'Trusted by 10,000+ UK customers'\n\nAbove footer: Customer reviews badge showing rating and count",
      "why": "Trust signals reduce bounce rate, increase time on page, and improve conversion - all positive SEO signals. AI engines also look for credibility indicators."
    }
  ]
}
