...
async function getSecondaryKeywords(primaryKeyword) {
  // TEMPORARILY DISABLED - Return empty data until Ahrefs API is configured
  console.log('[Ahrefs] Skipping Ahrefs calls (API not configured)');
  return {
    secondaryKeywords: [],
    betterKeyword: null,
    primaryKeywordMetrics: { keyword: primaryKeyword, volume: 0, difficulty: 0 }
  };
  
  /* ORIGINAL CODE - UNCOMMENT WHEN AHREFS API KEY IS ADDED TO VERCEL
  try {
